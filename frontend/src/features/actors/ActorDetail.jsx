      ...
      <div className="px-8 pb-12">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <div className="flex items-start gap-6 mb-6">
              ...
              <div className="flex-shrink-0">
                ...
                <div className={`w-48 h-48 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white/50 font-bold text-6xl border-4 border-white/20 ${actor.image_url ? 'hidden' : ''}`}>
              ...
              <div className="flex-1">
                ...
                {actor.date_of_birth && (
                  <div className="text-white/70 mb-4">
                    <span>Born: {new Date(actor.date_of_birth).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                  </div>
                )}
                {actor.bio && (
          ...
          {movies && movies.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white/90">Movies</h2>
